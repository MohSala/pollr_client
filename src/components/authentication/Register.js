...
export class Register extends Component {
    ...
    handleCreate = async () => {
        ...
        const { email, password, fullName, mobile } = this.state;
                ...
                <center>
                    ...
                    <div className="form-group col-sm-6" style={{ marginTop: "30px" }}>
                        ...
                        <input
                            ...
                            placeholder="ChukwuEmeka Chukwudi"
                            name="fullName" onChange={text => this.change("fullName", text)}
                    ...
                    <div className="form-group col-sm-6" style={{ marginTop: "30px" }}>
                        ...
                        <input
                            type="email"
                            className="form-control"
                            placeholder="nairamarley@yahoo.com"
                            name="email"
                    ...
                    <div className="form-group col-sm-6" style={{ marginTop: "30px" }}>
                        ...
                        <input type="tel"
                            className="form-control"
                            name="mobile" onChange={text => this.change("mobile", text)}
                            placeholder="08044940444" />
                    </div>
